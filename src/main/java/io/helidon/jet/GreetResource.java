...
public class GreetResource {
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public JsonArray getEmployees() throws FileNotFoundException {

		InputStream is = this.getClass().getResourceAsStream("/employeeData.json");
		JsonReader jsonReader = Json.createReader(is);
		JsonObject rootJSON = jsonReader.readObject();
		JsonArray jsonArray = rootJSON.getJsonArray("employees");
		return jsonArray;
	}
